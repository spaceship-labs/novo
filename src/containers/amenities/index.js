...
class AmenitiesContainer extends Component {
  ...
  getText = key => {
    const texts = {
      ...
      text16:
        this.props.lang === 'es'
          ? 'Un extraordinario condo con grandes ventanales que permiten el paso de la luz en cada habitación, para que contemples el hermoso paisaje a tu alrededor a cada paso que des. Altos techos -de hasta 4.2 metros-, en cada espacio del penthouse, crean la atmósfera idónea y un lienzo en blanco en las alturas, para un sinfín de opciones de decoración.la cocina cuenta con los mejores acabados en granito azul brasileño, y está completamente equipada con gabinetes importados de Italia y tres grandes hornos. Encontrarás detalles en mármol italiano, en diversos rincones del penthouse.'
