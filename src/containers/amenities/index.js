  ...
  getText = key => {
    const texts = {
      ...
      text16:
        this.props.lang === "es" ? (
          <span>
            Un extraordinario condo con grandes ventanales que permiten el paso
            de la luz en cada habitación, para que contemples el hermoso paisaje
            a tu alrededor a cada paso que des. Altos techos -de hasta 4.2
            metros-, en cada espacio de este penthouse de 467 m&#178;, crean la
            atmósfera idónea y un lienzo en blanco en las alturas, para un
            sinfín de opciones de decoración.la cocina cuenta con los mejores
            acabados en granito azul brasileño, y está completamente equipada
            con gabinetes importados de Italia y tres grandes hornos.
            Encontrarás detalles en mármol italiano, en diversos rincones del
            penthouse.
          </span>
        ) : (
          <span>
            Grand wall to wall windows allow the passage of light in every room
            so you can enjoy the scenic landscape every step you take! Walk
            across extraordinary 12 to 14 feet ceilings all throughout this 467
            m&#178; penthouse, setting the tone for every space, so you can have
            your own elevated canvas for décor opportunities! The kitchen has
            the best Blue Brazilian natural stone granite finishes, and is fully
            equipped with imported cabinets from Italy and has 3 large ovens.
            Italian marble can also be found in detailed touches across the rest
            of the penthouse.
          </span>
        ),
      text17:
        this.props.lang === "es"
          ? "Un lujoso departamento con 4 habitaciones, cada una con su propio baño y terraza. Una de las alcobas se encuentra en la planta baja, y las otras tres en la planta alta, donde está la habitación principal: este es el cuarto más espacioso de todos, con su propio clóset para él y ella, una terraza con jacuzzi y roof garden. Es una máster bedroom de dos pisos, con su propia sala, y baño completo con acabados de mármol italiano. Sobre las otras dos alcobas: cada una cuenta con baño completo tipo spa, balcón, y sutiles y elegantes detalles en cada rincón. Desde cada cuarto de la casa, podrás contemplar y apreciar los mejores amaneceres y atardeceres de Cancún, las turquesas aguas del caribe que lo rodean e impresionantes luces citadinas por la noche."
